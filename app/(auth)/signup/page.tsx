  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-ink-500">Register a manager account for dashboard access</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-ink-500">
        ...
        <Link href="/login" className="font-semibold text-spice-600 transition hover:text-spice-700">
          Sign in
        </Link>
      </p>
    </div>
